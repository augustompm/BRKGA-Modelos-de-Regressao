...
// Date: 29-04-2020 (first proposed, see official release info in beggining of
...
struct tkahan {
 ...
 public:
  ...
  template <class T2>
  constexpr tkahan(tkahan<T2> kother) : val(kother.getValue()) {}

  // build with T value (not 'explicit', may be automatic!)
  constexpr tkahan(T _val) : val(_val) {}

  // build with T value and T error
  constexpr tkahan(T _val, T _c) : val(_val), c(_c) {}

  // empty
  constexpr tkahan() {}

  T getValue() const { return this->val; }

  T getC() const { return this->c; }
  ...
  // reverse (unary minus)
  tkahan<T> operator-() const { return tkahan<T>(-this->val, -this->c); }
  ...
  bool operator!=(const tkahan<T>& other) const { return !((*this) == other); }
...
void kprint_bin(int val, int sz) {
...
struct std::numeric_limits<kahan::kfloat32> {
  ...
  static constexpr kahan::kfloat32 min() noexcept {
    return std::numeric_limits<float>::min();
  }

  static constexpr kahan::kfloat32 max() noexcept {
    return std::numeric_limits<float>::max();
  }

  static constexpr kahan::kfloat32 lowest() noexcept {
  ...
  static constexpr kahan::kfloat32 epsilon() noexcept {
    return std::numeric_limits<float>::epsilon();
  }

  static constexpr kahan::kfloat32 round_error() noexcept {
  ...
  static constexpr kahan::kfloat32 infinity() noexcept {
    return std::numeric_limits<float>::infinity();
  };

  static constexpr kahan::kfloat32 quiet_NaN() noexcept {
    return std::numeric_limits<float>::quiet_NaN();
  };

  static constexpr kahan::kfloat32 signaling_NaN() noexcept {
    return std::numeric_limits<float>::signaling_NaN();
  };

  static constexpr kahan::kfloat32 denorm_min() noexcept {
...
struct std::numeric_limits<kahan::kfloat64> {
  ...
  static constexpr kahan::kfloat64 min() noexcept {
    return std::numeric_limits<double>::min();
  }

  static constexpr kahan::kfloat64 max() noexcept {
    return std::numeric_limits<double>::max();
  }

  static constexpr kahan::kfloat64 lowest() noexcept {
  ...
  static constexpr kahan::kfloat64 epsilon() noexcept {
    return std::numeric_limits<double>::epsilon();
  }

  static constexpr kahan::kfloat64 round_error() noexcept {
  ...
  static constexpr kahan::kfloat64 infinity() noexcept {
    return std::numeric_limits<double>::infinity();
  };

  static constexpr kahan::kfloat64 quiet_NaN() noexcept {
    return std::numeric_limits<double>::quiet_NaN();
  };

  static constexpr kahan::kfloat64 signaling_NaN() noexcept {
    return std::numeric_limits<double>::signaling_NaN();
  };

  static constexpr kahan::kfloat64 denorm_min() noexcept {
...
struct std::numeric_limits<kahan::kfloat128> {
  ...
  static constexpr kahan::kfloat128 min() noexcept {
    return std::numeric_limits<long double>::min();
  }

  static constexpr kahan::kfloat128 max() noexcept {
    return std::numeric_limits<long double>::max();
  }

  static constexpr kahan::kfloat128 lowest() noexcept {
  ...
  static constexpr kahan::kfloat128 epsilon() noexcept {
    return std::numeric_limits<long double>::epsilon();
  }

  static constexpr kahan::kfloat128 round_error() noexcept {
  ...
  static constexpr bool has_signaling_NaN = has_quiet_NaN;
  // static constexpr float_denorm_style has_denorm = bool(__DBL_HAS_DENORM__) ?
  // denorm_present : denorm_absent;
  static constexpr bool has_denorm_loss =
      std::numeric_limits<long double>::has_denorm_loss;

  static constexpr kahan::kfloat128 infinity() noexcept {
    return std::numeric_limits<long double>::infinity();
  };

  static constexpr kahan::kfloat128 quiet_NaN() noexcept {
    return std::numeric_limits<long double>::quiet_NaN();
  };

  static constexpr kahan::kfloat128 signaling_NaN() noexcept {
    return std::numeric_limits<long double>::signaling_NaN();
  };

  static constexpr kahan::kfloat128 denorm_min() noexcept {
